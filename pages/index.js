...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title> श्री.चंद्रशेखर कृष्णराव बावनकुळे.</title>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-lg font-semibold text-blue-800">
        058-कामठी विधानसभा सार्वत्रिक निवडणूक 2024
        </h1>
        ...
        <p className="text-md font-medium mt-6">
          ...
          <span className="font-bold">श्री.चंद्रशेखर कृष्णराव बावनकुळे</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border-2 border-black text-center w-16">
                <img src="/CB.jpg" className=" m-auto" />
              </td>
              <td className="border-2 border-black text-center w-16">
    ...
    <span className="flex items-center">
      ...
      <audio ref={(el) => (audioRefs.current.audio2 = el)} src="/chandrashekhar.mp3" preload="auto"></audio>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center z-50">
                  <div className="relative">
                    ...
                    <img src='/Chandrashekhar.gif' alt="Full-screen" className="max-w-full max-h-full" />
                  </div>
                  <div>
                  {/* <a href="https://wa.link/92x71l">
                <button className="bg-green-500 text-white font-bold py-2 px-4 rounded-full flex items-center space-x-2">
